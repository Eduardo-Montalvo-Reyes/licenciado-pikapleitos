...
import { Youtube, Menu, X, FileText, ExternalLink } from 'lucide-react';
...
export default function App() {
  ...
  const colors = {
    bg: '#374151', // Gris Oxford Cenizo claro
    secondaryBg: '#1e293b', 
    accent: '#d4a017', 
    text: '#f9fafb',
    textMuted: '#d1d5db',
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: colors.bg, color: colors.text, fontFamily: "'Inter', sans-serif" }}>
      ...
      <main className="max-w-5xl mx-auto px-6 py-10 md:py-16">
        ...
        {/* SECCIÓN: FILOSOFÍA (Sin cambios, respetada totalmente) */}
        {activeTab === 'filosofia' && (
          <div className="animate-fade-in space-y-12">
            <div className="bg-[#1e293b] p-8 md:p-16 rounded-[3rem] border border-[#d4a017]/10 shadow-2xl relative">
              ...
              <div className="space-y-8 text-gray-100 text-base md:text-xl leading-relaxed text-justify">
                [cite_start]<p>Soy Licenciado en Derecho por la UNAM y maestrante en Derecho Laboral, ejerciendo activamente como abogado litigante independiente[cite: 10]. [cite_start]Esta dualidad me permite trasladar la realidad de los juzgados y la praxis jurídica directamente al aula, fomentando en los estudiantes un pensamiento crítico, ético y, sobre todo, práctico[cite: 11].</p>
                [cite_start]<p>Me he especializado en el diseño de planes de estudio personalizados mediante herramientas de mi autoría: los "Guiones de Cátedra" y "Temarios Temáticos"[cite: 12]. [cite_start]Estos instrumentos garantizan un control riguroso de los contenidos, una administración del tiempo optimizada y una dinámica grupal de excelencia[cite: 13].</p>
                [cite_start]<p>Mi metodología es pragmática; implemento proyectos de unidad donde el alumno someta la teoría a la prueba de la realidad, culminando en un Proyecto Integrador Final[cite: 16].</p>
                <div className="py-8 my-10 border-y border-[#d4a017]/20 text-center">
                  <p className="font-serif italic text-xl md:text-2xl text-gray-200">
                    [cite_start]"No concibo la docencia como un acto de mera transmisión de datos, sino como un ejercicio de responsabilidad humana y jurídica... El error en el aula es una lección, pero el error en la vida tiene un peso que marca"[cite: 17].
                  </p>
                </div>
                <div className="mt-16 text-center space-y-6">
                  <div className="space-y-1">
                    ...
                    [cite_start]<p className="text-md text-gray-400">Abogado Litigante y Catedrático [cite: 23]</p>
                  </div>
                  ...
                  <div className="max-w-2xl mx-auto">
                    ...
                    <p className="text-xs md:text-sm text-gray-400 leading-relaxed uppercase tracking-wider">
                      [cite_start]Derecho Constitucional y Amparo • Laboral y Seguridad Social • Mercantil • Civil • Epistemología • Ética[cite: 24].
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-[#1e293b] p-8 md:p-16 rounded-[3rem] border border-[#d4a017]/10 shadow-2xl">
              ...
              <div className="flex flex-col md:flex-row gap-12 items-start mb-16">
                <div className="w-full md:w-1/3 flex justify-center">
                  <div className="relative w-64 h-64 md:w-full aspect-square rounded-2xl overflow-hidden border-2 border-[#d4a017] shadow-lg">
                    {/* Espacio para la fotografía del CV */}
                    <img 
                      src="https://img.freepik.com/free-photo/handsome-businessman-suit-glasses-pointing-up-isolated-white_186202-6019.jpg" 
                ...
                <div className="w-full md:w-2/3 space-y-6 text-gray-100 text-base md:text-lg text-justify leading-relaxed">
                  <p>
                    [cite_start]Soy Abogado Litigante especializado en Derecho Laboral y Consultor Educativo con más de dos años de experiencia[cite: 34]. [cite_start]Mi perfil se distingue por la capacidad de análisis estratégico y la resolución de conflictos mediante una sólida fundamentación jurídica[cite: 60].
                  </p>
                  <p>
                    [cite_start]He liderado proyectos de alto impacto académico como el <strong>"Tribunal Escolar"</strong>, un ecosistema procesal donde los alumnos gestionan juicios completos, y el <strong>"Código Estudiantil"</strong>, que obliga a fundamentar cada conducta bajo un marco legal personalizado[cite: 43, 45].
                  </p>
                  <p>
                    [cite_start]Mi enfoque actual se centra en la excelencia técnica y la innovación pedagógica, utilizando la tecnología como un puente y nunca como un reemplazo del juicio humano[cite: 32, 37].
                  </p>
                </div>
              </div>

              {/* Apartado de Formación y Botón CV */}
              <div className="bg-black/20 p-8 rounded-2xl border border-white/5 text-center space-y-6">
                ...
                <p className="text-sm text-gray-400 italic">
                  En mi CV podrás encontrar más información relevante sobre mi trayectoria profesional y logros académicos.
                </p>
                <div className="pt-4">
                  <a 
                    href={cvLink} 
