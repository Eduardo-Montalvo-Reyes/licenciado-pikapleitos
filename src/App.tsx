  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: colors.bg, color: colors.text }}>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 md:py-20">
        ...
        {/* Filosofía - contenido integrado del PDF (Carta de Presentación) */}
        {activeTab === 'filosofia' && (
          <div className="max-w-5xl mx-auto space-y-12">
            ...
            {/* Foto integrada (reemplace la URL con la suya real) */}
            <div className="flex justify-center">
              <img 
                src="https://example.com/su-foto-perfil.jpg" // ← Cambie esta URL por la de su foto real (suba a Drive o ImgBB y ponga el link directo)
                alt="Eduardo Montalvo Reyes"
                className="w-48 h-48 rounded-full object-cover border-4 border-[#d4a017]/50 shadow-xl"
              />
            </div>

            {/* Texto exacto del PDF, formateado para legibilidad */}
            <div className="prose prose-lg max-w-none text-gray-300 leading-relaxed space-y-6 bg-[#1e293b] p-10 rounded-2xl border border-[#334155]">
              ...
              <p>
                Por medio de la presente, me permito someter a su atenta consideración mi perfil profesional para integrarme al cuerpo docente de su prestigiada institución en las áreas de Derecho o Ciencias Sociales.
              </p>
        ...
        {/* Las otras secciones quedan iguales (Conóceme, Innovación, etc.) */}
        {/* ... (puedes pegar aquí las secciones restantes de tu código anterior si quieres mantenerlas intactas) ... */}
