        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-10">
            {[
              ...
              { id: 'proyecto', label: 'PROYECTO FINAL', icon: <Target />, desc: 'Documento que certifica la culminación del proceso de aprendizaje. Exige coherencia y linealidad absoluta.' },
            ].map((item) => (
